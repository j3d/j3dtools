 ...
 * @author justin
 */
public class SimpleTiledTerrainDataTest
{
    @Mock
    ...
    public void testBasicConstruction() throws Exception
    {
        ...
        SimpleTiledTerrainData classUnderTest = new SimpleTiledTerrainData(mockHeightMapSource);

        assertEquals(classUnderTest.getSourceDataType(), TerrainData.TILED_DATA, "Incorrect data type");
        ...
        assertNull(classUnderTest.getTexture(0, 0), "No texture should be given by default");
...
/*
        ...
        assertNull(classUnderTest.getTexture(0, 0), "Texture image not removed");
*/
    }
    ...
    public void testArrayConstructionWithNoCopy() throws Exception
    {
        ...
        SimpleTiledTerrainData classUnderTest = new SimpleTiledTerrainData(TEST_HEIGHTS, false, TEST_GRID_STEP_SIZE);
    ...
    public void testArrayConstructionWithCopy() throws Exception
    {
        ...
        SimpleTiledTerrainData classUnderTest = new SimpleTiledTerrainData(TEST_HEIGHTS, true, TEST_GRID_STEP_SIZE);
