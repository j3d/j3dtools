 ...
 * <p>
 *
 * No default navigation type is selected, but the toolbar can be used to
...
public class NavSelectDemo extends DemoJFrame
{
    ...
    {
        NavSelectDemo demo = new NavSelectDemo();
