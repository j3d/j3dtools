...
public class EndianConverter
{
    ...
    {
        return convert(srcBuffer, destBuffer, srcLength, destOffset, destLength, 0xffffffff);
    }
    ...
    {
        return convert(srcBuffer, destBuffer, srcLength, destOffset, destLength, 0xffffffffffffffffL);
    ...
    public static int convert(int blockSize,
                              ...
                              int destLength)
    {
        return convert(blockSize, srcBuffer, destBuffer, srcLength, destOffset, destLength, 0xffffffff);
    }
                              ...
                              int mask)
    {
        ...
        {
            return convert(srcBuffer, destBuffer, srcLength, destOffset, destLength, mask);
        }
        else
        {
            return 0;
     ...
     *     <code>srcBuffer</code>.
     * @return number of processed short data from <code>srcBuffer</code>.
     *     Multiply by 8 to get the number of valid bytes in <code>destBuffer</code>.
     */
     ...
     * (will be <= destLength).
     */
    public static int read(byte[] readBuffer, short[] destBuffer, int destOffset, int destLength, InputStream stream)
        throws IOException
    {
        ...
        throws IOException
    {
        ...
        while((numOfBytesRead >= 0) && (numOfData < destLength))
        {
            ...
            int numOfProcessedBytes = convert(readBuffer,
                                              destBuffer,
     ...
     * (will be <= destLength).
     */
    public static int read(byte[] readBuffer, int[] destBuffer, int destOffset, int destLength, InputStream stream)
        throws IOException
    {
        ...
        throws IOException
    {
        while(srcLength >= 0)
        {
            int processedData = convertToLittleEndian(srcBuffer, tempBuffer, srcOffset, srcLength);
        ...
        throws IOException
    {
        while(srcLength > 0)
        {
            int processedData = convertToLittleEndian(blockSize, srcBuffer, tempBuffer, srcOffset, srcLength);
     ...
     */
    public static void writeLittleEndian(OutputStream stream, short value)
        throws IOException
    {
        stream.write(value);
     ...
     */
    public static void writeLittleEndian(OutputStream stream, int value)
        throws IOException
    {
        stream.write(value);
        stream.write(value >> 8);
     ...
     */
    public static void writeLittleEndian(OutputStream stream, long value)
        throws IOException
    {
        for(int i = 0; i < 8; i++)
        {
    ...
    private static int read2ByteBlock(byte[] readBuffer,
                                      int[] destBuffer,
                                      int destOffset,
                                      int destLength,
                                      InputStream stream,
        ...
        throws IOException
    {
        ...
        while((numOfBytesRead >= 0) && (numOfData < destLength))
        {
            ...
            int numOfProcessedBytes = convert(2,
                                              readBuffer,
                                              destBuffer,
                                              numOfBytesRead + offset,
                                              destOffset + numOfData,
    ...
    private static int read3ByteBlock(byte[] readBuffer,
                                      int[] destBuffer,
                                      int destOffset,
                                      int destLength,
                                      InputStream stream,
        ...
        throws IOException
    {
        ...
        while((numOfBytesRead >= 0) && (numOfData < destLength))
        {
            ...
            numOfBytesRead = stream.read(readBuffer, offset, maxBytesToRead - offset);
            int numOfProcessedBytes = convert(3,
                                              readBuffer,
                                              destBuffer,
                                              numOfBytesRead + offset,
                                              destOffset + numOfData,
