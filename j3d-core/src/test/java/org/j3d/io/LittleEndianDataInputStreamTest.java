...
public class LittleEndianDataInputStreamTest
{
    ...
    public void testSimpleByteArrayReading() throws Exception
    {
        ...
        LittleEndianDataInputStream classUnderTest = new LittleEndianDataInputStream(test_input);
    ...
    public void testReadShort() throws Exception
    {
        ...
        for(int i = 0; i < test_data.length; i++)
        {
            dos.writeShort(EndianConverter.convert(test_data[i]));
        }
    ...
    public void testReadChar() throws Exception
    {
        ...
        for(int i = 0; i < test_data.length; i++)
        {
            dos.writeChar(EndianConverter.convert((short)test_data[i]));
        }
    ...
    public void testReadInt() throws Exception
    {
        ...
        for(int i = 0; i < test_data.length; i++)
        {
            dos.writeInt(EndianConverter.convert(test_data[i]));
        }
    ...
    {
        final int[] test_data = { 0, 10, -400, 300, -5 };
    ...
    public void testReadLong() throws Exception
    {
        ...
        for(int i = 0; i < test_data.length; i++)
        {
            dos.writeLong(EndianConverter.convert(test_data[i]));
        }
    ...
    public void testReadFloat() throws Exception
    {
        ...
        for(int i = 0; i < test_data.length; i++)
        {
            dos.writeInt(EndianConverter.convert(Float.floatToIntBits(test_data[i])));
        }
    ...
    public void testReadBulkFloats() throws Exception
    {
        ...
        for(int i = 0; i < test_data.length; i++)
        {
            assertEquals(test_result[i], test_data[i], 0.001, "Test data at index " + i + " was not correct");
        }
    }
    ...
    public void testReadDouble() throws Exception
    {
        ...
        for(int i = 0; i < test_data.length; i++)
        {
            dos.writeLong(EndianConverter.convert(Double.doubleToLongBits(test_data[i])));
        }
