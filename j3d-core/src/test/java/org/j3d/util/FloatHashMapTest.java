...
public class FloatHashMapTest
{
    ...
    {
        FloatHashMap<Object> classUnderTest = new FloatHashMap<>();
        ...
        assertFalse(classUnderTest.containsKey(0.7f), "Should not contain any key");
        assertNull(classUnderTest.remove(0.6f), "Cannot remove successfully an entry it does not contain");
        assertNull(classUnderTest.get(0.6f), "Cannot get an entry it does not contain");
    }
