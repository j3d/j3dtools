...
public class DoubleHashMapTest
{
    ...
    {
        DoubleHashMap<Object> classUnderTest = new DoubleHashMap<>();
        ...
        assertFalse(classUnderTest.containsKey(0.7), "Should not contain any key");
        assertNull(classUnderTest.remove(0.6), "Cannot remove successfully an entry it does not contain");
        assertNull(classUnderTest.get(0.6), "Cannot get an entry it does not contain");
    }
