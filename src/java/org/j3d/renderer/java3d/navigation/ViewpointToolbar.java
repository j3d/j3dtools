    ...
    implements ActionListener, ItemListener
{
     ...
     */
    public void setViewpoints(J3DViewpointData[] vp)
    {
     ...
     * @param vp The data for the new viewpoint
     */
    public void insertViewpoint(int index, J3DViewpointData vp)
    {
     ...
     */
    public void removeViewpoint(J3DViewpointData vp)
    {
     ...
     */
    public void selectViewpoint(J3DViewpointData vp)
    {
