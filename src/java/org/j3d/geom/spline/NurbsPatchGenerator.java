...
/**
 * Geometry generator for generating rectangular Nurbs patches.
 * <P>
 *
 * Nurbs patches of all orders are permitted. Order information is derived
 ...
 */
public class NurbsPatchGenerator extends GeometryGenerator
{
     ...
     *
     * @param facets The number of facets on the side of the patch
     * @throws IllegalArgumentException The number of facets is less than 3
     */
    public NurbsPatchGenerator(int facets)
    {
        if(facets < 3)
    ...
    /**
     * Change the number of facets used to create this patch. This will cause
...
//                break;
   ...
   /**
     ...
     * side of the patch is a single fan, but the patch is one big fan.
     *
     * @param data The data to patch the calculations on
     * @throws InvalidArraySizeException The array is not big enough to contain
     *   the requested geometry
     ...
     * index will always be the patch tip - parallel for each face so that we
     ...
     * top normal of the patch is always perpendicular to the face.
     *
     * @param data The data to patch the calculations on
     * @throws InvalidArraySizeException The array is not big enough to contain
     *   the requested geometry
    ...
    /**
     * Regenerate the patch coordinate points. These are the basic patch that
     * makes up the grid of points.
     */
